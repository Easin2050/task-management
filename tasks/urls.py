...
from tasks.views import Higreetings,Greetings,HiHowgreetings,test,dashboard, manager_dashboard,employee_dashboard,delete_task, create_task, view_task,update_task,task_details
